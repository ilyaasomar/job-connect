...
const Navbar = () => {
  ...
  return (
    <div className="bg-[#F3F7FA] w-full border-b border-primaryColor-0">
      <div className="px-4 lg:container mx-auto">
        <div className="flex items-center justify-between py-2">
          ...
          <div className="relative flex items-center gap-x-16">
            ...
            {open && (
              <>
                <div className="absolute top-[60px] rounded-b-lg bg-primaryColor right-0 w-56 h-fit z-10 py-5">
